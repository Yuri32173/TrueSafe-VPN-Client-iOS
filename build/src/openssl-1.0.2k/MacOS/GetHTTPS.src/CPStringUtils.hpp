...
int ComparePStrs(const unsigned char *theFirstPStr, const unsigned char *theSecondPStr, const int ignoreCase);
int CompareCStrs(const char *theFirstCStr, const char *theSecondCStr, const int ignoreCase);
int CompareCStrToPStr(const char *theCStr, const unsigned char *thePStr, const int ignoreCase);

int CStrsAreEqual(const char *theFirstCStr, const char *theSecondCStr, const int ignoreCase);
int PStrsAreEqual(const unsigned char *theFirstCStr, const unsigned char *theSecondCStr, const int ignoreCase);
...
long FindCharOffsetInCStr(const char theChar, const char *theCString, const int inIgnoreCase);
long FindCStrOffsetInCStr(const char *theCSubstring, const char *theCString, const int inIgnoreCase);
